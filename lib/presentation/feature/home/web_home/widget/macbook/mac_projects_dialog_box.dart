        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ///with animation starts

              // return AnimatedSwitcher(
              //     duration: const Duration(milliseconds: 500),
              //     transitionBuilder: (Widget child, Animation<double> animation) {
              //       final isNext = child.key == const ValueKey<int>(1);

              //   return SlideTransition(
              //     position: Tween<Offset>(
              //       begin: isNext ? const Offset(1.0, 0.0) : const Offset(0.0, 0.0),
              //       // Slide in from right
              //       end: Offset.zero,
              //     ).animate(CurvedAnimation(
              //       parent: animation,
              //
              //       curve: Curves.easeOut, // Smoother animation
              //     )),
              //     child: child,
              //   );
              //
              ...
              //                                     platformTitle:
              //                                         LocaleKeys.android.toLocalizeString,
              ...
              //                     ProjectDetailsOverviewRowWidget(
