...
class AppColors {
  ...
  static const Color kYellow = Color(0xFFFDC200);
  static const Color kRed = Color(0xFFFF0000);
  static const Color kDisableColor = Color(0xFFB6B6B6);

  static const Color kBaseColor = Color(0xFFFCF9F5); //60%
  //
  static const Color kDarkPrimary = Color(0xFFC59A6C); //todo: need to choose color
  static const Color kSecondary = Color(0xFFFDF9F5);
  static const Color kSecondaryDark = Color(0xFFE1D9D0);
...
//   static const Color kHorizontalCalenderPrimary = Color(0xFFc49a6c);
//   static const Color kDarkGold = Color(0xFF6D4922);
//   static const Color kTextBrownColor = Color(0xFF885B2B);
//   static const Color kSecondaryTextBrownColor = Color(0xFFC49A6C);
//   static const Color kHomeContainerSecondaryShade = Color(0xFFFFF5EB);
//   static const Color kDivider = Color(0xFFEEE8E1);
//   static const Color kExtraLightCream = Color(0xFFf6e9db);
//   static const Color kCamelColor = Color(0xFFC49A6C);
//   static const Color kWhiteChocolate = Color(0xFFEDE1D4);
//   static const Color kCultured = Color(0xFFF5F5F5);
//
//   static const Color kCosmicLatte = Color(0xFFFEF6E9);
//   static const Color kHoneydew = Color(0xFFF0FCF3);
//   static const Color kLavender = Color(0xFFDDE6FF);
//   static const Color kPigmentRed = Color(0xFFED1C25);
//   static const dividerColorApp = Color(0xFFEEE8E1);
//
//   static const Color kBookmarkGreen = Color(0xFF34B550);
//   static const Color kBookmarkBlue = Color(0xFF2E36EA);
//   static const Color kBookmarkYellow = Color(0xFFFFD600);
//   static const Color kBookmarkRed = Color(0xFFE41E1E);
//   static const Color kSeashell = Color(0xFFF9F5F0);
//
//   static const Color kPdfCreamColor = Color(0xffFFF6EC);
//
//   /// actual colors
//   static const Color k885B2BDarkBrownFont = Color(0xFF6D4922);
//   static const Color kFFEEDC = Color(0xFFFFEEDC);
//   static const Color kC49A6CLightBrown = Color(0xFFC49A6C);
//   static const Color kFCF9F5BaseColor = Color(0xFFFCF9F5); //60%   kBaseColor
//   static const Color kFFF7EELightCalenderBg = Color(0xFFFFF7EE);
//
//   static const Color kSelectionColor = Color(0xFFFFF7EE);
//
// // static const Color kFFF7EELightCalenderBg = Color(0xFFFFF7EE);
//
// // static const Color kPdfCreamColor = Color(0xFFFFD700);
//
// // static const Color kDisabledPrimary = Color(0xFF5A5D60);
// // static const Color kDisabledSecondary = Color(0xFF93A3A9);
// //
// // // static const Color kSecondary = Color(0xFF1D59A6);
// //
// // static const Color kWhite = Color(0xFFFFFFFF);
// // static const Color kBlack = Color(0xFF000000);
// //
// // static const Color kBgShadowWhite = Color(0xFFFCFCFF);
// // static const Color kGhostWhite = Color(0xFFF7F8FA);
// //
// // static const Color kIslamicGreen = Color(0xFF018E03);
// //
// // static const Color kHarvestGold = Color(0xFFD99F00);
// // static const Color kSaffron = Color(0xFFF9C338);
// // static const Color kCornSilk = Color(0xFFFFF6E1);
// //
// // static const Color kBackgroundBlack = Color(0xFF121212);
// // static const Color kCardBlack = Color(0xFF1E1E1E);
// // static const Color kBorderBlack = Color(0xFF2C2C2C);
// //
// // static const Color subWhite = Color(0xFFE0E0E0);
// // static const Color subGrey = Color(0xFFA0A0A0);
// //
// // static const Color lineGreyColor = Color(0xFFE4E4E4);
// // static const Color textGreyColor = Color(0xFF707070);
// // static const Color red = Color(0xFFF5564E);
// //
// // static const Color skyBlueColor = Color(0xFFDFEDFF);
// //
// // static const Color lavenderIndigoColor = Color(0xFF9A3FFF);
// //
// // static const Color grey = Color(0xFF8C8C8C);
// // static const Color ratingStarColor = Color(0xFFFFC627);
// // static const Color tundoraLight = Color(0xFF4A4A4A);
// // static const Color green = Color(0xFF27AE60);
// // static const Color alphaWhite = Color(0xB3ffffff);
// // static const Color checkBoxBlueColor = Color(0xFF0092FF);
// //
// // static const Color kLightThemeBlackText = Color(0xFF212427);
// // static const Color kSpanishBlue = Color(0xFF006EB8);
// // static const Color kLightSteelBlue = Color(0xFFAFCFDF);
// // static const Color kPlatinum = Color(0xFFE0E2E6);
// // static const Color kDarkGoldenrod = Color(0xFFB48000);
// //
// // static const Color kGunmetal = Color(0xFF242A38);
// // static const Color kDarkBronze = Color(0xFF4E4400);
// // static const Color kGainsboro = Color(0xFFDBDBDB);
// // static const Color kOldSilver = Color(0xFF858585);
// // static const Color kPhilippineSilver = Color(0xFFB7B7B7);
// // static const Color kGraniteGray = Color(0xFF606060);
// // static const Color kDavyGrey = Color(0xFF606060);
// // static const Color kCanaryYellow = Color(0xFFFFED00);
// // static const Color kSunglow = Color(0xFFF9C63A);
// // static const Color kDarkGray = Color(0xFFA8A8A8);
// // static const Color kCultured = Color(0xFFF6F6F4);
// // static const Color kSpanishGray = Color(0xFF979797);
// // static const Color kSilver = Color(0xFFB9B9B9);
// // static const Color kBronzeYellow = Color(0xFF725F00);
// // static const Color kLightSilver = Color(0xFFD6D6D6);
// // static const Color kSilverChalice = Color(0xFFACACAC);
// // static const Color kPigmentRed = Color(0xFFED1C25);
// }
//
...
class GradientColors {
  ...
  static List<Color> get blueHomePageGradient => [
        const Color(0xFFFDFEFF),
        const Color(0xFFEFF6FE),
      ];

  static List<Color> get greenHomePageGradient => [
        const Color(0xFFFDFEFD),
        const Color(0xFFF2F9F1),
      ];

  static List<Color> get darkGoldHomePageGradient => [
        const Color(0xFF1E1E1E),
        const Color(0xFF282828),
      ];

  static List<Color> get darkWhiteHomePageGradient => [
        const Color(0xFF1C2128),
        const Color(0xFF252A33),
      ];

  static List<Color> get goldHomePageGradient => [
